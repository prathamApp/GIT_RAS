...
import com.pratham.readandspeak.services.STTService;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                if (AppStartDateTime == null)
                    pauseTime = RASApplication.getCurrentDateTime(false, "");
                else
                    pauseTime = RASApplication.getCurrentDateTime(true, AppStartDateTime);
                return null;
            }
        }.execute();
