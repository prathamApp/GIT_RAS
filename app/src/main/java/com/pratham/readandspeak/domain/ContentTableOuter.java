...
public class ContentTableOuter implements Comparable, Parcelable {
    ...
    public List<ContentTable> contentTableList;

    public List<ContentTable> getContentTableList() {
        return contentTableList;
    }

    public void setContentTableList(List<ContentTable> contentTableList) {
    ...
    public ContentTableOuter() {

    }


    public ContentTableOuter(Parcel in) {
        level = in.readString();
    ...
    public static final Creator<ContentTableOuter> CREATOR = new Creator<ContentTableOuter>() {
        @Override
        public ContentTableOuter createFromParcel(Parcel in) {
            return new ContentTableOuter(in);
        }

        @Override
        public ContentTableOuter[] newArray(int size) {
            return new ContentTableOuter[size];
        }
    };
    ...
    public int compareTo(@NonNull Object o) {
        ContentTableOuter compare = (ContentTableOuter) o;
