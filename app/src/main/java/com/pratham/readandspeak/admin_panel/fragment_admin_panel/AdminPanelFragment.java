...
import com.pratham.readandspeak.admin_panel.PullData.PullDataFragment;
import com.pratham.readandspeak.admin_panel.fragment_admin_panel.PushOrAssign.PushOrAssignFragment;
...
public class AdminPanelFragment extends Fragment implements AdminPanelContract.AdminPanelView {
    ...
    public void openPullDataFragment() {
        RAS_Utility.showFragment(getActivity(), new PullDataFragment(), R.id.frame_attendance,
    ...
    public void onLoginSuccess() {
        RAS_Utility.showFragment(getActivity(), new PushOrAssignFragment(), R.id.frame_attendance,
