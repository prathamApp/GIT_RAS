package com.pratham.readandspeak.admin_panel.PullData;
...
import com.pratham.readandspeak.domain.RaspCrl;
import com.pratham.readandspeak.domain.RaspGroup;
import com.pratham.readandspeak.domain.RaspStudent;
import com.pratham.readandspeak.domain.RaspVillage;
import com.pratham.readandspeak.domain.Student;
import com.pratham.readandspeak.domain.Village;
import com.pratham.readandspeak.utilities.APIs;
...
import static com.pratham.readandspeak.utilities.APIs.ECE;
import static com.pratham.readandspeak.utilities.APIs.PI;
import static com.pratham.readandspeak.utilities.APIs.RI;
import static com.pratham.readandspeak.utilities.APIs.SC;
import static com.pratham.readandspeak.utilities.APIs.UP;
...
//        List<Modal_Village> allStudent = villageList.get(0).getData();
    ...
    public void checkConnectivity() {
        if (RASApplication.wiseF.isDeviceConnectedToMobileNetwork()) {
            //callOnlineContentAPI(contentList, parentId);
        } else if (RASApplication.wiseF.isDeviceConnectedToWifiNetwork()) {
    ...
    public boolean checkConnectionForRaspberry() {
        ...
        if (RASApplication.wiseF.isDeviceConnectedToWifiNetwork()) {
            if (RASApplication.wiseF.isDeviceConnectedToSSID(RAS_Constants.PRATHAM_KOLIBRI_HOTSPOT)) {
                try {
                    isRaspberry = true;
