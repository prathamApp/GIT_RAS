...
import com.pratham.readandspeak.admin_panel.group_selection.fragment_child_attendance.FragmentChildAttendance;
...
public class FragmentSelectGroup extends Fragment implements ContractGroup {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String groupId1 = AppDatabase.getDatabaseInstance(getActivity()).getStatusDao().getValue(RAS_Constants.GROUPID1);

        if (!groupId1.equalsIgnoreCase("0")) present_groups.add(groupId1);
        String groupId2 = AppDatabase.getDatabaseInstance(getActivity()).getStatusDao().getValue(RAS_Constants.GROUPID2);
        ...
        String groupId3 = AppDatabase.getDatabaseInstance(getActivity()).getStatusDao().getValue(RAS_Constants.GROUPID3);
        ...
        String groupId4 = AppDatabase.getDatabaseInstance(getActivity()).getStatusDao().getValue(RAS_Constants.GROUPID4);
...
//        String groupId4 = BaseActivity.statusDao.getValue(PD_Constant.GROUPID4);
        ...
        String groupId5 = AppDatabase.getDatabaseInstance(getActivity()).getStatusDao().getValue(RAS_Constants.GROUPID5);
        ...
        if (getArguments().getBoolean(RAS_Constants.GROUP_AGE_BELOW_7)) {
...
//    }
    ...
    public void setNext(View v) {
        if (groupSelected != null) {
            ...
            bundle.putParcelableArrayList(RAS_Constants.STUDENT_LIST, students);
            bundle.putString(RAS_Constants.GROUPID, groupSelected.getGroupId());
            RAS_Utility.showFragment(getActivity(), new FragmentChildAttendance(), R.id.frame_group,
